...
### RESOURCE GROUP ####
#######################
resource_group_name = "USEPEYXP01RSG03"
location            = "East US"
resource_group_tags = {
  "hidden-title" = "EYX - Prod-Pilot - App",
  "ROLE_PURPOSE" = "EYX - Prod-Pilot - App"
...
################################
log_analytics_workspace_name = "USEPEYXP01LAW03"
log_analytics_workspace_tags = {
  "hidden-title" = "EYX - Prod-Pilot - App LAW",
  "ROLE_PURPOSE" = "EYX - Prod-Pilot - App LAW"
}
...
key_vault_tags = {
  "hidden-title" = "EYX - Prod-Pilot - App Key Vault",
  "ROLE_PURPOSE" = "EYX - Prod-Pilot - App Key Vault"
}
...
######## AZURE WORKBOOK ########
################################
workbook_display_name = "EYX Dashboard Workbook Prod-Pilot"
workbook_tags = {
  "ROLE_PURPOSE" = "EYX - Prod-Pilot - Workbook"
}
...
################################################
# NOTE: Syncing with existing Azure resource - preserving existing configuration
user_assigned_identity_name = "USEPEYXP01UMI02"

user_assigned_identity_tags = {
  "hidden-title" = "EYX - Prod-Pilot - User Assigned Identity",
  "ROLE_PURPOSE" = "EYX - Prod-Pilot - User Assigned Identity"
}
