...
route_table_apim_name   = "USEUEYXU01UDR03"
...
route_table_apim_tags = {
  "hidden-title" = "EYX - UAT-Prod - APIM UDR"
}

nsg_app_name_01_tags = {
  "hidden-title" = "EYX - UAT-Prod - Frontend Inbound NSG"
}

nsg_app_name_02_tags = {
  "hidden-title" = "EYX - UAT-Prod - App Services Outbound NSG"
}

nsg_app_name_03_tags = {
  "hidden-title" = "EYX - UAT-Prod - APIM Integration"
}

nsg_app_name_04_tags = {
  "hidden-title" = "EYX - UAT-Prod - Backend Inbound"
}

nsg_app_name_05_tags = {
  "hidden-title" = "EYX - UAT-Prod - OpenAI Inbound"
}

nsg_app_name_06_tags = {
  "hidden-title" = "EYX - UAT-Prod - ACA"
}
...
#### vnet app 01 (frontend) IPAM -> CTILEYXIPAM-App-UAT-Prod-IPRange01
vnet_name_app_01               = "USEUEYXU01VNT06"
vnet_address_space_app_01      = ["10.217.249.0/25"]
subnet1_name_app_01            = "USEUEYXU01SBN15"
subnet2_name_app_01            = "USEUEYXU01SBN16"
subnet3_name_app_01            = "USEUEYXU01SBN17"
subnet1_address_prefix_app_01  = "10.217.249.0/27"
subnet2_address_prefix_app_01  = "10.217.249.32/27"
subnet3_address_prefix_app_01  = "10.217.249.64/26"
...
#### vnet app 02 (backend) IPAM -> CTILEYXIPAM-App-UAT-Prod-IPRange02
vnet_name_app_02               = "USEUEYXU01VNT07"
vnet_address_space_app_02      = ["10.217.249.128/25"]
subnet1_name_app_02            = "USEUEYXU01SBN18"
subnet2_name_app_02            = "USEUEYXU01SBN19"
subnet3_name_app_02            = "USEUEYXU01SBN20"
subnet1_address_prefix_app_02  = "10.217.249.128/27"
subnet2_address_prefix_app_02  = "10.217.249.160/27"
subnet3_address_prefix_app_02  = "10.217.249.192/26"
...
additional_security_rules_nsg_app_01 = [
  ...
  },
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefixes    = ["10.217.249.32/27"] # subnet2_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  },
  # This rule allows traffic from APIM to App Services Private Endpoints
  {
    ...
    source_address_prefixes    = ["10.217.249.64/26"] # subnet3_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  }
]
...
additional_security_rules_nsg_app_02 = [
  {
    ...
    destination_address_prefixes = ["10.217.249.0/27"] # subnet1_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.249.64/26"] # subnet3_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "*"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.249.128/27"] # subnet1_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.249.160/27"] # subnet2_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.249.192/26"] # subnet3_address_prefix_app_02
  }
]
