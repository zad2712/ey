...
route_table_apim_name   = "USEUEYXU01UDR01"

### VNET SPECIFIC TAGS
vnet_admin_tags = {
  "hidden-title"      = "EYX - UAT-Lab - Runners VNET"
...
nsg_admin_tags = {
  "hidden-title" = "EYX - UAT - Admin Runners Subnet NSG"
}

nsg_app_name_01_tags = {
  "hidden-title" = "EYX - UAT-Lab - Frontend Inbound NSG"
}

nsg_app_name_02_tags = {
  "hidden-title" = "EYX - UAT-Lab - App Services Outbound NSG"
}

nsg_app_name_03_tags = {
  "hidden-title" = "EYX - UAT-Lab - APIM Integration"
}

nsg_app_name_04_tags = {
  "hidden-title" = "EYX - UAT-Lab - Backend Inbound"
}

nsg_app_name_05_tags = {
  "hidden-title" = "EYX - UAT-Lab - OpenAI Inbound"
}

nsg_app_name_06_tags = {
  "hidden-title" = "EYX - UAT-Lab - ACA"
}
...
### VNETS ##########
###################
#### vnet admin 01 IPAM -> CTILEYXIPAM-Admin-UAT-IPRange01
# vnet_name_admin_01          = "USEUEYXU01VNT01"
# vnet_address_space_admin_01 = ["10.47.17.32/27"]
# subnet1_name                = "USEUEYXU01SBN01"
# subnet1_address_prefix      = "10.47.17.32/28"
# subnet2_name                = "USEUEYXU01SBN02"
# subnet2_address_prefix      = "10.47.17.48/28"
...
#### vnet app 01 (frontend) IPAM -> CTILEYXIPAM-App-Lab-IPRange01
vnet_name_app_01               = "USEUEYXU01VNT02"
vnet_address_space_app_01      = ["10.217.232.0/25"]
subnet1_name_app_01            = "USEUEYXU01SBN03"
subnet2_name_app_01            = "USEUEYXU01SBN04"
subnet3_name_app_01            = "USEUEYXU01SBN05"
subnet1_address_prefix_app_01  = "10.217.232.0/27"
subnet2_address_prefix_app_01  = "10.217.232.32/27"
subnet3_address_prefix_app_01  = "10.217.232.64/26"
...
#### vnet app 02 (backend) IPAM -> CTILEYXIPAM-App-Lab-IPRange02
vnet_name_app_02               = "USEUEYXU01VNT03"
vnet_address_space_app_02      = ["10.217.233.0/25"]
subnet1_name_app_02            = "USEUEYXU01SBN06"
subnet2_name_app_02            = "USEUEYXU01SBN07"
subnet3_name_app_02            = "USEUEYXU01SBN08"
subnet1_address_prefix_app_02  = "10.217.233.0/27"
subnet2_address_prefix_app_02  = "10.217.233.32/27"
subnet3_address_prefix_app_02  = "10.217.233.64/26"
...
#################
#### NSG admin and app
# nsg_admin_name_01 = "USEUEYXU01NSG01"
# nsg_admin_name_02  = "USEUEYXU01NSG02"

nsg_app_name_01 = "USEUEYXU01NSG03"
nsg_app_name_02 = "USEUEYXU01NSG04"
nsg_app_name_03 = "USEUEYXU01NSG05"
nsg_app_name_04 = "USEUEYXU01NSG06"
nsg_app_name_05 = "USEUEYXU01NSG07"
nsg_app_name_06 = "USEUEYXU01NSG08"
...
additional_security_rules_nsg_app_01 = [
  ...
  },
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefixes    = ["10.217.232.32/27"] # subnet2_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  },
  # This rule allows traffic from APIM to App Services Private Endpoints
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "443"
    source_address_prefixes    = ["10.217.232.64/26"] # subnet3_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  }
]
...
additional_security_rules_nsg_app_02 = [
  {
    ...
    destination_address_prefixes = ["10.217.232.0/27"] # subnet1_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.232.64/26"] # subnet3_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "*"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.233.0/27"] # subnet1_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.233.32/27"] # subnet2_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.217.233.64/26"] # subnet3_address_prefix_app_02
  }
]
...
#################################
github_network_settings_name = "USEUEYXU01GHNS01"
business_id                  = "8023"