...
route_table_apim_name   = "USEPEYXP01UDR01"

### VNET SPECIFIC TAGS
vnet_admin_tags = {
  "hidden-title"      = "EYX - Prod-Lab - Runners VNET"
...
route_table_apim_tags = {
  "hidden-title" = "EYX - Prod-Lab - APIM UDR"
}
...
nsg_admin_tags = {
  "hidden-title" = "Prod-Lab - Admin Runners Subnet NSG"
}

nsg_app_name_01_tags = {
  "hidden-title" = "EYX - Prod-Lab - Frontend Inbound NSG"
}

nsg_app_name_02_tags = {
  "hidden-title" = "EYX - Prod-Lab - App Services Outbound NSG"
}

nsg_app_name_03_tags = {
  "hidden-title" = "EYX - Prod-Lab - APIM Integration"
}

nsg_app_name_04_tags = {
  "hidden-title" = "EYX - Prod-Lab - Backend Inbound"
}

nsg_app_name_05_tags = {
  "hidden-title" = "EYX - Prod-Lab - OpenAI Inbound"
}

nsg_app_name_06_tags = {
  "hidden-title" = "EYX - Prod-Lab - ACA"
}
...
### VNETS ##########
###################
#### vnet app 01 (frontend) IPAM -> CTILEYXIPAM-App-Prod-Lab-IPRange01
vnet_name_app_01               = "USEPEYXP01VNT02"
vnet_address_space_app_01      = ["10.133.14.128/25"]
subnet1_name_app_01            = "USEPEYXP01SBN03"
subnet2_name_app_01            = "USEPEYXP01SBN04"
subnet3_name_app_01            = "USEPEYXP01SBN05"
subnet1_address_prefix_app_01  = "10.133.14.128/27"
subnet2_address_prefix_app_01  = "10.133.14.160/27"
subnet3_address_prefix_app_01  = "10.133.14.192/26"
...
#### vnet app 02 (backend) IPAM -> CTILEYXIPAM-App-Prod-Lab-IPRange02
vnet_name_app_02               = "USEPEYXP01VNT03"
vnet_address_space_app_02      = ["10.133.22.0/25"]
subnet1_name_app_02            = "USEPEYXP01SBN06"
subnet2_name_app_02            = "USEPEYXP01SBN07"
subnet3_name_app_02            = "USEPEYXP01SBN08"
subnet1_address_prefix_app_02  = "10.133.22.0/27"
subnet2_address_prefix_app_02  = "10.133.22.32/27"
subnet3_address_prefix_app_02  = "10.133.22.64/26"
...
#################
#### NSG admin and app
nsg_admin_name_01 = "USEPEYXP01NSG01"
# nsg_admin_name_02  = "USEPEYXP01NSG02"

nsg_app_name_01 = "USEPEYXP01NSG03"
nsg_app_name_02 = "USEPEYXP01NSG04"
nsg_app_name_03 = "USEPEYXP01NSG05"
nsg_app_name_04 = "USEPEYXP01NSG06"
nsg_app_name_05 = "USEPEYXP01NSG07"
nsg_app_name_06 = "USEPEYXP01NSG08"
...
additional_security_rules_nsg_app_01 = [
  {
    ...
    source_address_prefixes    = ["10.28.40.64/27"] # CTILEYXIPAM-Admin-Prod-IPRange01
    destination_address_prefix = "VirtualNetwork"
  },
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefixes    = ["10.133.14.160/27"] # subnet2_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  },
  # This rule allows traffic from APIM to App Services Private Endpoints
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "443"
    source_address_prefixes    = ["10.133.14.192/26"] # subnet3_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  }
]
...
additional_security_rules_nsg_app_02 = [
  {
    ...
    destination_address_prefixes = ["10.133.14.128/27"] # subnet1_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.14.192/26"] # subnet3_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "*"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.22.0/27"] # subnet1_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.22.32/27"] # subnet2_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.22.64/26"] # subnet3_address_prefix_app_02
  }
]
...
#################################
github_network_settings_name = "USEPEYXP01GHNS01"
business_id                  = "8023"
