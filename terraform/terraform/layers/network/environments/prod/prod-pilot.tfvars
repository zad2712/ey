...
route_table_apim_name   = "USEPEYXP01UDR03"

### VNET SPECIFIC TAGS
vnet_admin_tags = {
  "hidden-title"      = "EYX - Prod-Pilot - Runners VNET"
...
route_table_apim_tags = {
  "hidden-title" = "EYX - Prod-Pilot - APIM UDR"
}
...
nsg_admin_tags = {
  "hidden-title" = "Prod-Pilot - Admin Runners Subnet NSG"
}

nsg_app_name_01_tags = {
  "hidden-title" = "EYX - Prod-Pilot - Frontend Inbound NSG"
}

nsg_app_name_02_tags = {
  "hidden-title" = "EYX - Prod-Pilot - App Services Outbound NSG"
}

nsg_app_name_03_tags = {
  "hidden-title" = "EYX - Prod-Pilot - APIM Integration"
}

nsg_app_name_04_tags = {
  "hidden-title" = "EYX - Prod-Pilot - Backend Inbound"
}

nsg_app_name_05_tags = {
  "hidden-title" = "EYX - Prod-Pilot - OpenAI Inbound"
}

nsg_app_name_06_tags = {
  "hidden-title" = "EYX - Prod-Pilot - ACA"
}
...
#### vnet app 01 (frontend) IPAM -> CTILEYXIPAM-App-Prod-Pilot-IPRange01
vnet_name_app_01               = "USEPEYXP01VNT04"
vnet_address_space_app_01      = ["10.133.30.0/25"]
subnet1_name_app_01            = "USEPEYXP01SBN09"
subnet2_name_app_01            = "USEPEYXP01SBN10"
subnet3_name_app_01            = "USEPEYXP01SBN11"
subnet1_address_prefix_app_01  = "10.133.30.0/27"
subnet2_address_prefix_app_01  = "10.133.30.32/27"
subnet3_address_prefix_app_01  = "10.133.30.64/26"
...
#### vnet app 02 (backend) IPAM -> CTILEYXIPAM-App-Prod-Pilot-IPRange02
vnet_name_app_02               = "USEPEYXP01VNT05"
vnet_address_space_app_02      = ["10.133.34.128/25"]
subnet1_name_app_02            = "USEPEYXP01SBN12"
subnet2_name_app_02            = "USEPEYXP01SBN13"
subnet3_name_app_02            = "USEPEYXP01SBN14"
subnet1_address_prefix_app_02  = "10.133.34.128/27"
subnet2_address_prefix_app_02  = "10.133.34.160/27"
subnet3_address_prefix_app_02  = "10.133.34.192/26"
...
additional_security_rules_nsg_app_01 = [
  ...
  },
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefixes    = ["10.133.30.32/27"] # subnet2_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  },
  # This rule allows traffic from APIM to App Services Private Endpoints
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "443"
    source_address_prefixes    = ["10.133.30.64/26"] # subnet3_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  }
]
...
additional_security_rules_nsg_app_02 = [
  {
    ...
    destination_address_prefixes = ["10.133.30.0/27"] # subnet1_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.30.64/26"] # subnet3_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "*"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.34.128/27"] # subnet1_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.34.160/27"] # subnet2_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.133.34.192/26"] # subnet3_address_prefix_app_02
  }
]
