...
hidden_title_tag_env = "dev1"

# Route Table - Enable APIM UDR for all environments
enable_apim_route_table = true
route_table_apim_name   = "USEDCXS05HUDR02"

### VNET SPECIFIC TAGS
vnet_admin_tags = {
  "hidden-title"      = "EYX - Dev-1 - Runners VNET"
...
route_table_apim_tags = {
  "hidden-title" = "EYX - Dev1 - APIM UDR"
}
...
nsg_admin_tags = {
  "hidden-title" = "Dev-1 - Admin Runners Subnet NSG"
}

nsg_app_name_01_tags = {
  "hidden-title" = "EYX - Dev-1 - Frontend Inbound NSG"
}

nsg_app_name_02_tags = {
  "hidden-title" = "EYX - Dev-1 - App Services Outbound NSG"
}

nsg_app_name_03_tags = {
  "hidden-title" = "EYX - Dev-1 - APIM Integration"
}

nsg_app_name_04_tags = {
  "hidden-title" = "EYX - Dev-1 - Backend Inbound"
}

nsg_app_name_05_tags = {
  "hidden-title" = "EYX - Dev-1 - OpenAI Inbound"
}

nsg_app_name_06_tags = {
  "hidden-title" = "EYX - Dev-1 - ACA"
}
...
### VNETS ##########
###################
#### vnet app 01 (frontend) IPAM -> CTILEYXIPAM-App-Dev1-IPRange01
vnet_name_app_01               = "USEDCXS05HVNT04"
vnet_address_space_app_01      = ["10.19.44.0/25"]
subnet1_name_app_01            = "USEDCXS05HSBN09"
subnet2_name_app_01            = "USEDCXS05HSBN10"
subnet3_name_app_01            = "USEDCXS05HSBN11"
subnet1_address_prefix_app_01  = "10.19.44.0/27"
subnet2_address_prefix_app_01  = "10.19.44.32/27"
subnet3_address_prefix_app_01  = "10.19.44.64/26"
...
#### vnet app 02 (backend) IPAM -> CTILEYXIPAM-App-Dev1-IPRange02
vnet_name_app_02               = "USEDCXS05HVNT05"
vnet_address_space_app_02      = ["10.19.45.128/25"]
subnet1_name_app_02            = "USEDCXS05HSBN12"
subnet2_name_app_02            = "USEDCXS05HSBN13"
subnet3_name_app_02            = "USEDCXS05HSBN14"
subnet1_address_prefix_app_02  = "10.19.45.128/27"
subnet2_address_prefix_app_02  = "10.19.45.160/27"
subnet3_address_prefix_app_02  = "10.19.45.192/26"
...
#################
#### NSG admin and app
nsg_admin_name_01 = "USEDCXS05HNSG01"
# nsg_admin_name_02  = "USEDCXS05HNSG02"
...
additional_security_rules_nsg_app_01 = [
  ...
  },
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefixes    = ["10.19.44.32/27"] # subnet2_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  },
  # This rule allows traffic from APIM to App Services Private Endpoints
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "443"
    source_address_prefixes    = ["10.19.44.64/26"] # subnet3_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  }
]
...
additional_security_rules_nsg_app_02 = [
  {
    ...
    destination_address_prefixes = ["10.19.44.0/27"] # subnet1_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.44.64/26"] # subnet3_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "*"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.45.128/27"] # subnet1_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.45.160/27"] # subnet2_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.45.192/26"] # subnet3_address_prefix_app_02
  }
]
