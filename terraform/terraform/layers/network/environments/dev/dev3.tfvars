...
hidden_title_tag_env = "dev3"

# Route Table - Enable APIM UDR for all environments
enable_apim_route_table = true
route_table_apim_name   = "USEDCXS05HUDR04"

### VNET SPECIFIC TAGS
vnet_admin_tags = {
  "hidden-title"      = "EYX - Dev-3 - Runners VNET"
...
route_table_apim_tags = {
  "hidden-title" = "EYX - Dev3 - APIM UDR"
}
...
nsg_admin_tags = {
  "hidden-title" = "Dev-3 - Admin Runners Subnet NSG"
}

nsg_app_name_01_tags = {
  "hidden-title" = "EYX - Dev-3 - Frontend Inbound NSG"
}

nsg_app_name_02_tags = {
  "hidden-title" = "EYX - Dev-3 - App Services Outbound NSG"
}

nsg_app_name_03_tags = {
  "hidden-title" = "EYX - Dev-3 - APIM Integration"
}

nsg_app_name_04_tags = {
  "hidden-title" = "EYX - Dev-3 - Backend Inbound"
}

nsg_app_name_05_tags = {
  "hidden-title" = "EYX - Dev-3 - OpenAI Inbound"
}

nsg_app_name_06_tags = {
  "hidden-title" = "EYX - Dev-3 - ACA"
}
...
#### vnet app 01 (frontend) IPAM -> CTILEYXIPAM-App-Dev3-IPRange01
vnet_name_app_01               = "USEDCXS05HVNT08"
vnet_address_space_app_01      = ["10.19.57.0/25"]
subnet1_name_app_01            = "USEDCXS05HSBN21"
subnet2_name_app_01            = "USEDCXS05HSBN22"
subnet3_name_app_01            = "USEDCXS05HSBN23"
subnet1_address_prefix_app_01  = "10.19.57.0/27"
subnet2_address_prefix_app_01  = "10.19.57.32/27"
subnet3_address_prefix_app_01  = "10.19.57.64/26"
...
#### vnet app 02 (backend) IPAM -> CTILEYXIPAM-App-Dev3-IPRange02
vnet_name_app_02               = "USEDCXS05HVNT09"
vnet_address_space_app_02      = ["10.19.57.128/25"]
subnet1_name_app_02            = "USEDCXS05HSBN24"
subnet2_name_app_02            = "USEDCXS05HSBN25"
subnet3_name_app_02            = "USEDCXS05HSBN26"
subnet1_address_prefix_app_02  = "10.19.57.128/27"
subnet2_address_prefix_app_02  = "10.19.57.160/27"
subnet3_address_prefix_app_02  = "10.19.57.192/26"
...
additional_security_rules_nsg_app_01 = [
  ...
  },
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefixes    = ["10.19.57.32/27"] # subnet2_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  },
  # This rule allows traffic from APIM to App Services Private Endpoints
  {
    ...
    source_port_range          = "*"
    destination_port_range     = "443"
    source_address_prefixes    = ["10.19.57.64/26"] # subnet3_address_prefix_app_01
    destination_address_prefix = "VirtualNetwork"
  }
]
...
additional_security_rules_nsg_app_02 = [
  {
    ...
    destination_address_prefixes = ["10.19.57.0/27"] # subnet1_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.57.64/26"] # subnet3_address_prefix_app_01
  },
  {
    ...
    destination_port_range       = "*"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.57.128/27"] # subnet1_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.57.160/27"] # subnet2_address_prefix_app_02
  },
  {
    ...
    destination_port_range       = "443"
    source_address_prefix        = "VirtualNetwork"
    destination_address_prefixes = ["10.19.57.192/26"] # subnet3_address_prefix_app_02
  }
]
