...
app_insights_app_pilot_name           = "USEPEYXP01AAI02"
app_insights_app_prod_name            = "USEPEYXP01AAI03"
resource_group_name_app_pilot         = "USEPEYXP01RSG03"
resource_group_name_app_prod          = "USEPEYXP01RSG04"
...
storage_account_app_01                                 = "USEPEYXP01STA04"
...
storage_account_app_02                                 = "USEPEYXP01STA05"
...
app_service_plan_name_app_03 = "USEPEYXP01ASP06"
...
web_app_name_app_01                     = "USEPEYXP01WAP05"
web_app_https_only_app_01               = true
web_app_always_on_app_01                = true
#web_app_ftps_state_app_01               = "FtpsOnly" # Moved to locals
...
app_service_windows_ui_cors = {
  allowed_origins = [
    ...
    "https://eyx-prod-lab-use.ey.com",
  ]
  support_credentials = true
}

### app_service_windows_web_api #####
web_app_name_app_02                     = "USEPEYXP01WAP06"
...
app_service_windows_api_cors = {
  allowed_origins = [
    # Update values with prod ones
    "https://api.eyq.eyfabric.ey.com",
    "https://apim.eyx-prod-lab-use.ey.com",
    "https://eyq.eyfabric.ey.com",
    "https://eyx-prod-lab-use.ey.com",
    "https://usepeyxp01wap08.azurewebsites.net"
  ]
  support_credentials = true
}

### app_service_windows_notice_api #####
web_app_name_app_03                         = "USEPEYXP01WAP07"
...
web_app_name_app_04                            = "USEPEYXP01WAP08"
...
#### FUNCTION APP  ################
#####################################
function_app_name_app_01                 = "USEPEYXP01AZF02"
...
function_app_01_app_settings = {
  ...
  "GithubWorkflowToken"                        = "@Microsoft.KeyVault(VaultName=USEPEYXP01AKV02;SecretName=GithubToken)"
  "GithubWorkflowFile"                         = "agent-workflow-test-gha.yml"
  "GithubWorkflowEnvironment"                  = "prod"
  "GithubWorkflowBranch"                       = "main"
...
################
#### signalr_name_app_01
signalr_name_app_01      = "USEPEYXP01SNR02"
...
# CONTAINER APP #
#################
container_app_name = "usepeyxp01aca02"
...
session_pool_name                    = "usepeyxp01aca02-python-pool"
...
session_pool_app_service_managed_identities = [
  "USEPEYXP01WAP06" # Web API app service
...
#########################
# openai_account_name = "USEPEYXP01oai02"
openai_sku_name                      = "S0"
openai_custom_subdomain_name         = "usepeyxp01oai02"
...
##################################
speech_account_name                  = "USEPEYXP01SPC02"
speech_service_custom_subdomain_name = "USEPEYXP01SPC02"
speech_sku_name                      = "S0"

#######################################
# AZURE DOCUMENT INTELLIGENCE SERVICE #
#######################################
document_intelligence_account_name          = "USEPEYXP01ADI02"
document_intelligence_custom_subdomain_name = "USEPEYXP01ADI02"
document_intelligence_sku_name              = "S0"

######################################
#### PRIVATE ENDPOINTS NAMES #########
######################################
web_app_ui_pep_name                     = "USEPEYXP01PEP0D"
web_app_api_pep_name                    = "USEPEYXP01PEP0E"
web_app_notice_api_pep_name             = "USEPEYXP01PEP0F"
web_app_kernel_memory_pep_name          = "USEPEYXP01PEP0G"
function_app_pep_name                   = "USEPEYXP01PEP0H"
storage_account_app_logs_pep_name_queue = "USEPEYXP01PEP0I"
storage_account_app_pep_name_blob       = "USEPEYXP01PEP0J"
storage_account_app_pep_name_table      = "USEPEYXP01PEP0K"
storage_account_app_pep_name_queue      = "USEPEYXP01PEP0L"
storage_account_app_logs_pep_name_blob  = "USEPEYXP01PEP0M"
speech_account_pep_name                 = "USEPEYXP01PEP0N"
document_intelligence_pep_name          = "USEPEYXP01PEP0O"
container_registry_pep_name             = "USEPEYXP01PEP0P"
container_app_environment_pep_name      = "USEPEYXP01PEP2A"